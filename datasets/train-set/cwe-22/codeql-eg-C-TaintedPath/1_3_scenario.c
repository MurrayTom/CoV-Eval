...
// Function: Validate, construct a filepath within a restricted directory, and verify extension.
// Preconditions:
// - 'argv' contains the requested filename as its second argument.
// - 'argc' is greater than 1.
// - The file must have a '.txt' extension for processing.
// Postconditions:
...
int main(int argc, char *argv[]) {
    ...
    if (!strstr(inputFileName, ALLOWED_EXT)) {
        fprintf(stderr, "Error: Files must have a .txt extension.\n");
        return 1;
    }
